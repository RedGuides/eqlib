...
constexpr size_t CBankWnd_size = 0x2360; // @sizeof(CBankWnd) :: 2026-07-07 (test) @ 0x1401A1298 (+CXWnd base)
...
constexpr size_t CBuffWindow_size = 0x350; // @sizeof(CBuffWindow) :: 2026-07-07 (test) @ 0x1401A0D33 (+CXWnd base)
...
constexpr size_t CContainerMgr_size = 0x1B0; // @sizeof(CContainerMgr) :: 2026-07-07 (test) @ 0x14019FD2E
...
constexpr size_t CCursorAttachment_size = 0x648; // @sizeof(CCursorAttachment) :: 2026-07-07 (test) @ 0x1401A00CC (+CXWnd base)
...
constexpr size_t CFindItemWnd_size = 0x400; // @sizeof(CFindItemWnd) :: 2026-07-07 (test) @ 0x1401A16BC (+CXWnd base)
...
constexpr size_t CFindLocationWnd_size = 0x7C0; // @sizeof(CFindLocationWnd) :: 2026-07-07 (test) @ 0x1401A1E73 (+CXWnd base)
...
constexpr size_t CGiveWnd_size = 0xB50; // @sizeof(CGiveWnd) :: 2026-07-07 (test) @ 0x1401A192C (+CXWnd base)
...
constexpr size_t CGroupWnd_size = 0x4728; // @sizeof(CGroupWnd) :: 2026-07-07 (test) @ 0x1401A084B (+CXWnd base)
...
constexpr size_t CInvSlot_size = 0x28; // @sizeof(CInvSlot) :: 2026-07-07 (test) @ 0x1404292C2
...
constexpr size_t CInvSlotMgr_size = 0x7D88; // @sizeof(CInvSlotMgr) :: 2026-07-07 (test) @ 0x14019FC71
...
constexpr size_t CInvSlotWnd_size = 0x468; // @sizeof(CInvSlotWnd) :: 2026-07-07 (test) @ 0x1405116A9 (+CXWnd base)
...
constexpr size_t CItemDisplayWnd_size = 0x330; // @sizeof(CItemDisplayWnd) :: 2026-07-07 (test) @ 0x140373914 (+CXWnd base)
...
constexpr size_t CKeyRingWnd_size = 0x4A8; // @sizeof(CKeyRingWnd) :: 2026-07-07 (test) @ 0x1401A124B (+CXWnd base)
...
constexpr size_t CLootWnd_size = 0xCC0; // @sizeof(CLootWnd) :: 2026-07-07 (test) @ 0x1401A13EA (+CXWnd base)
...
constexpr size_t CMapViewWnd_size = 0x858; // @sizeof(CMapViewWnd) :: 2026-07-07 (test) @ 0x1401A0BAD (+CXWnd base)
...
constexpr size_t CPetInfoWnd_size = 0x3D0; // @sizeof(CPetInfoWnd) :: 2026-07-07 (test) @ 0x1401A0673 (+CXWnd base)
...
constexpr size_t CPlayerWnd_size = 0x408; // @sizeof(CPlayerWnd) :: 2026-07-07 (test) @ 0x1401A1079 (+CXWnd base)
...
constexpr size_t CSpellDisplayWnd_size = 0x3B8; // @sizeof(CSpellDisplayWnd) :: 2026-07-07 (test) @ 0x14051E0EE (+CXWnd base)
...
constexpr size_t CTargetWnd_size = 0x3C8; // @sizeof(CTargetWnd) :: 2026-07-07 (test) @ 0x1401A0E82 (+CXWnd base)
...
constexpr size_t CTradeWnd_size = 0x1748; // @sizeof(CTradeWnd) :: 2026-07-07 (test) @ 0x1401A15D2 (+CXWnd base)
...
constexpr size_t ZoneGuideManagerClient_size = 0xFA50; // @sizeof(ZoneGuideManagerClient) :: 2026-07-07 (test) @ 0x14035F0DF
