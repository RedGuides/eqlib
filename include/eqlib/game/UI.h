...
constexpr size_t CButtonWnd_size = 0x338; // @sizeof(CButtonWnd) :: 2026-08-25 (test) @ 0x1405fcda0
...
/*0x254*/ bool                  bPicture;
/*0x258*/ eqstd::shared_ptr<CRadioGroup> pGroup;
/*0x268*/ bool                  Checked;
...
/*0x334*/ EButtonStyle          ButtonStyle;
/*0x338*/
...
constexpr size_t AdvancedLootItem_size = 0xB0; // @sizeof(AdvancedLootItem) :: 2026-08-25 (test) @ 0x1400a3acd
...
/*0x388*/ CButtonWnd*               pTextLinkPLTemplate;     // ADLW_TextLinkPLTemplate
...
constexpr size_t CBankWnd_size = 0x2348; // @sizeof(CBankWnd) :: 2026-08-25 (test) @ 0x1401a16a8
...
constexpr size_t CBuffWindow_size = 0x338; // @sizeof(CBuffWindow) :: 2026-08-25 (test) @ 0x1401a1143
...
constexpr size_t CContainerMgr_size = 0x1B0; // @sizeof(CContainerMgr) :: 2026-08-25 (test) @ 0x1401a013e
...
constexpr size_t CCursorAttachment_size = 0x630; // @sizeof(CCursorAttachment) :: 2026-08-25 (test) @ 0x1401a04dc
...
constexpr size_t CFindItemWnd_size = 0x3F0; // @sizeof(CFindItemWnd) :: 2026-08-25 (test) @ 0x1401a1acc
...
constexpr size_t CFindLocationWnd_size = 0x7A8; // @sizeof(CFindLocationWnd) :: 2026-08-25 (test) @ 0x1401a2283
...
constexpr size_t CGiveWnd_size = 0xB38; // @sizeof(CGiveWnd) :: 2026-08-25 (test) @ 0x1401a1d3c
...
constexpr size_t CGroupWnd_size = 0x4710; // @sizeof(CGroupWnd) :: 2026-08-25 (test) @ 0x1401a0c5b
...
/*0x46f0*/ eqstd::string     strUnknown;
/*0x4710*/
};
...
constexpr size_t CInvSlot_size = 0x28; // @sizeof(CInvSlot) :: 2026-08-25 (test) @ 0x140429e12
...
constexpr size_t CInvSlotMgr_size = 0x7D88; // @sizeof(CInvSlotMgr) :: 2026-08-25 (test) @ 0x1401a0081
...
constexpr size_t CInvSlotWnd_size = 0x450; // @sizeof(CInvSlotWnd) :: 2026-08-25 (test) @ 0x14051227c
...
constexpr size_t CItemDisplayWnd_size = 0xA98; // @sizeof(CItemDisplayWnd) :: 2026-08-25 (test) @ 0x14044a064
...
constexpr size_t CKeyRingWnd_size = 0x490; // @sizeof(CKeyRingWnd) :: 2026-08-25 (test) @ 0x1401a165b
...
constexpr size_t CLootWnd_size = 0xCA8; // @sizeof(CLootWnd) :: 2026-08-25 (test) @ 0x1401a17fa
...
constexpr size_t CMapViewWnd_size = 0x828; // @sizeof(CMapViewWnd) :: 2026-08-25 (test) @ 0x1401a0fbd
...
constexpr size_t CPetInfoWnd_size = 0x3B8; // @sizeof(CPetInfoWnd) :: 2026-08-25 (test) @ 0x1401a0a83
...
constexpr size_t CPlayerWnd_size = 0x3F0; // @sizeof(CPlayerWnd) :: 2026-08-25 (test) @ 0x1401a1489
...
constexpr size_t CSpellDisplayWnd_size = 0x3A0; // @sizeof(CSpellDisplayWnd) :: 2026-08-25 (test) @ 0x14051ecce
...
/*0x390*/ int                SpellID;
/*0x394*/ int                CastAsLevel;               // Used in 3rd param of spell tag string %d
...
constexpr size_t CTargetWnd_size = 0x3B0; // @sizeof(CTargetWnd) :: 2026-08-25 (test) @ 0x1401a1292
...
constexpr size_t CTradeWnd_size = 0x1730; // @sizeof(CTradeWnd) :: 2026-08-25 (test) @ 0x1401a19e2
...
constexpr size_t ZoneGuideManagerClient_size = 0xFA50; // @sizeof(ZoneGuideManagerClient) :: 2026-08-25 (test) @ 0x14035fbff
