...
constexpr size_t CXWnd_size = 0x258; // @sizeof(CXWnd, eqmain) :: 2026-05-11 (test) @ 0x1800d9d8b
...
/*0x171*/ bool               bClientClipRectChanged;
