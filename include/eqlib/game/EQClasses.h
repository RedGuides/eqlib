...
constexpr size_t EQWorldData_size = 0x1F88; // @sizeof(EQWorldData) :: 2026-08-25 (test) @ 0x140273a77
...
constexpr size_t SkillManager_size = 0x399C80; // @sizeof(SkillManager) :: 2026-08-25 (test) @ 0x140273bb7
