...
constexpr size_t CGroupMember_size = 0x68; // @sizeof(CGroupMember) :: 2026-08-25 (test) @ 0x1402d3ced
...
constexpr size_t PcClient_size = 0x3298; // @sizeof(PcClient) :: 2026-08-25 (test) @ 0x14029339b
