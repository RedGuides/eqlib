...
constexpr size_t EQGroundItem_size = 0xA0; // @sizeof(EQGroundItem) :: 2026-07-08 (test) @ 0x14020583B
...
constexpr size_t EQSwitch_size = 0x108; // @sizeof(EQSwitch) :: 2026-07-08 (test) @ 0x1401FC90E
