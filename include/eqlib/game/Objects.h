...
constexpr size_t EQGroundItem_size = 0xA0; // @sizeof(EQGroundItem) :: 2026-04-30 (live) @ 0x1402006c3
...
constexpr size_t EQSwitch_size = 0x108; // @sizeof(EQSwitch) :: 2026-04-30 (live) @ 0x1401f7664
