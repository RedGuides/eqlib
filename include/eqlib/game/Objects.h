...
constexpr size_t EQGroundItem_size = 0xA0; // @sizeof(EQGroundItem) :: 2026-05-11 (test) @ 0x140200910
...
constexpr size_t EQSwitch_size = 0x108; // @sizeof(EQSwitch) :: 2026-05-11 (test) @ 0x1401f78b4
