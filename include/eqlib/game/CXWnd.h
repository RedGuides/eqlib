...
constexpr size_t CXWnd_size = 0x268; // @sizeof(CXWnd) :: 2026-05-11 (test) @ 0x1405d8a46
...
constexpr size_t CSidlScreenWnd_size = 0x2D0; // @sizeof(CSidlScreenWnd) :: 2026-05-11 (test) @ 0x1405f82d1
