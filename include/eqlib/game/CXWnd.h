...
/*0x081*/ bool dShow;
/*0x082*/ uint8_t Unknown_0x082[0x2];
/*0x084*/ CXRect IconRect;
/*0x094*/ bool bNeedsSaving;
/*0x095*/ uint8_t Unknown_0x095[0x3];
/*0x098*/ int HScrollPos;
/*0x09c*/ uint32_t Unknown_0x09c;
