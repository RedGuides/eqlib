...
/*0x1d8*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x1e0*/ int64_t                  HPCurrent;
/*0x1e8*/ unsigned int             SitStartTime;
/*0x1ec*/ char                     Handle[0x20];
/*0x20c*/ int                      RealEstateID;
/*0x210*/ int                      Birthdate;
...
/*0x458*/ PlayerClient*            pViewPlayer;
/*0x460*/ int                      ManaCurrent;
/*0x464*/ unsigned int             LastMealTime;
/*0x468*/ CRaceGenderInfo*         pRaceGenderInfo;
/*0x470*/ bool                     PvPFlag;
/*0x471*/ char                     Suffix[0x80];
/*0x4f1*/ bool                     berserker;
/*0x4f2*/ uint8_t                  Original;
/*0x4f3*/ uint8_t                  AltAttack;
/*0x4f4*/ float                    MissileRangeToTarget;
/*0x4f8*/ CharacterZoneClient*     pCharacter;
/*0x500*/ unsigned int             LastRangedUsedTime;
...
/*0x566*/ bool                     bAlwaysShowAura;
/*0x567*/ uint8_t                  FD;
/*0x568*/ unsigned int             StunTimer;
/*0x56c*/ int                      DoSpecialMelee;
/*0x570*/ uint8_t                  FindBits;
/*0x571*/ uint8_t                  Light;
/*0x572*/ uint8_t                  LastAttack;
/*0x573*/ bool                     bAnimationOnPop;
/*0x574*/ uint8_t                  CharClass;
/*0x575*/ uint8_t                  TitleVisible;
/*0x576*/ bool                     bSwitchMoved;
/*0x577*/ bool                     bBuffTimersOnHold;
/*0x578*/ bool                     DraggingPlayer;
/*0x579*/ bool                     GM;
/*0x57a*/ bool                     Mercenary;
/*0x57b*/ uint8_t                  Unknown0x57b[0x9];
/*0x584*/ CPhysicsInfo             LastCollision;
/*0x5b4*/ uint8_t                  Unknown0x5b4[0x18];
/*0x5cc*/ char                     LoginRelated[0x20];
