...
/*0x01d8*/ int                      Unknown0x1d8;
/*0x01dc*/ bool                     PvPFlag;
/*0x01dd*/ char                     Title[0x80];
/*0x0260*/ int                      PetID;
/*0x0264*/ char                     Handle[0x20];
/*0x0284*/ bool                     Unknown0x284;
/*0x0285*/ bool                     bAnimationOnPop;
/*0x0288*/ unsigned int             CorpseDragCount;
/*0x028c*/ int                      Buyer;
/*0x0290*/ float                    AnimationSpeedRelated;
/*0x0294*/ unsigned int             EnduranceMax;
/*0x0298*/ bool                     bOfflineMode;
/*0x029c*/ unsigned int             LastPrimaryUseTime;
/*0x02a0*/ uint8_t                  HoldingAnimation;
/*0x02a4*/ float                    MerchantGreed;
/*0x02a8*/ bool                     IntimidateState;
/*0x02a9*/ uint8_t                  FishingEvent;
/*0x02ac*/ int                      IsAttacking;
/*0x02b0*/ int                      PrimaryTintIndex;
/*0x02b4*/ bool                     bBetaBuffed;
/*0x02b8*/ int                      FamiliarID;
...
/*0x0360*/ unsigned int             LastSecondaryUseTime;
/*0x0364*/ float                    GetMeleeRangeVar1;
/*0x0368*/ unsigned int             LastResendAddPlayerPacket;
/*0x036c*/ unsigned int             MinuteTimer;
/*0x0370*/ bool                     bSummoned;
/*0x0374*/ int                      Birthdate;
/*0x0378*/ EqItemGuid               realEstateItemGuid;
/*0x038a*/ uint8_t                  GMRank;
/*0x038c*/ float                    CameraOffset;
/*0x0390*/ unsigned int             Meditating;
/*0x0394*/ int                      Unknown0x394;
/*0x0398*/ bool                     bBuffTimersOnHold;
/*0x039c*/ unsigned int             LastRefresh;
/*0x03a0*/ int                      Unknown0x3a0;
/*0x03a4*/ unsigned int             MasterID;
/*0x03a8*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x03b0*/ int64_t                  GuildID;
/*0x03b8*/ bool                     bShowHelm;
/*0x03b9*/ bool                     Sneak;
/*0x03bc*/ int                      NpcTintIndex;
/*0x03c0*/ uint8_t                  IntimidateCount;
/*0x03c4*/ unsigned int             FishingETA;
/*0x03c8*/ int64_t                  HPCurrent;
/*0x03d0*/ unsigned int             HibernatingCount;
/*0x03d4*/ int                      RealEstateItemId;
/*0x03d8*/ bool                     LFG;
/*0x03d9*/ uint8_t                  InPvPArea;
/*0x03dc*/ unsigned int             SitStartTime;
/*0x03e0*/ unsigned int             StunTimer;
/*0x03e4*/ unsigned int             LastMealTime;
/*0x03e8*/ uint8_t                  StandState;
/*0x03e9*/ char                     DragNames[2][0x40];
...
/*0x04ac*/ uint8_t                  Unknown0x4ac;
/*0x04ad*/ char                     Suffix[0x80];
/*0x0530*/ int                      ManaMax;
/*0x0534*/ int                      HideMode;
/*0x0538*/ unsigned int             LastRangedUsedTime;
...
/*0x0589*/ uint8_t                  TitleVisible;
/*0x058a*/ uint8_t                  CharClass;
/*0x058b*/ bool                     bSwitchMoved;
/*0x058c*/ float                    MyWalkSpeed;
/*0x0590*/ int                      Unknown0x590;
/*0x0594*/ int                      Unknown0x594;
/*0x0598*/ char                     LoginRelated[0x20];
/*0x05b8*/ unsigned int             Unknown0x5b8;
/*0x05bc*/ unsigned int             NextIntimidateTime;
...
/*0x11d4*/ unsigned int             Unknown0x11d4;
/*0x11d8*/ unsigned int             CollisionCounter;
/*0x11dc*/ float                    CachedCeilingLocationY;
/*0x11e0*/ float                    CachedCeilingLocationX;
/*0x11e4*/ float                    CachedCeilingLocationZ;
/*0x11e8*/ float                    CachedCeilingHeight;
/*0x11ec*/ CCapsule                 StaticCollision;
/*0x1208*/ float                    CachedFloorLocationY;
/*0x120c*/ float                    CachedFloorLocationX;
/*0x1210*/ float                    CachedFloorLocationZ;
/*0x1214*/ float                    CachedFloorHeight;
...
constexpr size_t PlayerClient_size = 0x20B0; // @sizeof(PlayerClient) :: 2026-05-11 (test) @ 0x14030787e
