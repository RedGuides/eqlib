...
/*0x1d0*/ uint8_t                  FD;
/*0x1d1*/ char                     Suffix[0x63];
/*0x234*/ int                      Birthdate;
/*0x238*/ float                    CameraOffset;
/*0x23c*/ unsigned int             Meditating;
/*0x240*/ int                      Unknown0x394;
...
/*0x264*/ unsigned int             LastPrimaryUseTime;
/*0x268*/ float                    MerchantGreed;
/*0x26c*/ int                      IsAttacking;
/*0x270*/ int                      PrimaryTintIndex;
/*0x274*/ int                      FamiliarID;
/*0x278*/ unsigned int             LastTick;
/*0x27c*/ int                      SecondaryTintIndex;
/*0x280*/ unsigned int             LastTrapDamageTime;
/*0x284*/ int                      Unknown0x220;
/*0x288*/ uint8_t                  Unknown0x3ef;
/*0x289*/ bool                     Unknown0x284;
...
/*0x2fc*/ char                     Handle[0x20];
/*0x31c*/ uint8_t                  FishingEvent;
/*0x31d*/ bool                     bBetaBuffed;
/*0x31e*/ bool                     bAnimationOnPop;
/*0x31f*/ bool                     bOfflineMode;
/*0x320*/ int                      Unknown0x354;
/*0x324*/ int                      Unknown0x340;
/*0x328*/ EqItemGuid               realEstateItemGuid;
/*0x33a*/ uint8_t                  Unknown0x33a[0x6];
/*0x340*/ char                     Title[0x10];
/*0x350*/ char                     DragNames[2][0x38];
/*0x3c0*/ uint8_t                  Unknown0x3c0[0x8];
/*0x3c8*/ int64_t                  GuildID;
/*0x3d0*/ int                      PetID;
/*0x3d4*/ uint8_t                  Unknown0x3d4;
/*0x3d5*/ bool                     bStationary;
/*0x3d6*/ bool                     bShowHelm;
...
/*0x3e1*/ bool                     bTempPet;
/*0x3e2*/ uint8_t                  Unknown0x3e2[0x6];
/*0x3e8*/ uint8_t                  Unknown0x43e;
/*0x3e9*/ uint8_t                  TitleVisible;
/*0x3ea*/ uint8_t                  CharClass;
/*0x3eb*/ bool                     bSwitchMoved;
/*0x3ec*/ int                      Trader;
/*0x3f0*/ CharacterZoneClient*     pCharacter;
/*0x3f8*/ bool                     bBuffTimersOnHold;
...
/*0x42c*/ uint8_t                  Unknown0x42c;
/*0x42d*/ uint8_t                  AltAttack;
/*0x42e*/ uint8_t                  FindBits;
/*0x42f*/ uint8_t                  Light;
/*0x430*/ int                      Unknown0x594;
/*0x434*/ unsigned int             Unknown0x434;
...
/*0x514*/ int                      DoSpecialMelee;
/*0x518*/ unsigned int             Unknown0x630;
/*0x51c*/ int                      NpcTintIndex;
/*0x520*/ unsigned int             LastRangedUsedTime;
/*0x524*/ unsigned int             Unknown0x63c;
/*0x528*/ unsigned int             EnduranceMax;
/*0x52c*/ unsigned int             LoginSerial;
...
constexpr size_t PlayerClient_size = 0x20D8; // @sizeof(PlayerClient) :: 2026-05-11 (test) @ 0x14030787e
