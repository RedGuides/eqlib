...
/*0x1d8*/ void*                    Unknown0x1d8;
/*0x1e0*/ int64_t                  HPCurrent;
/*0x1e8*/ char                     Handle[0x20];
/*0x208*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x210*/ int                      Birthdate;
/*0x214*/ int                      EnduranceCurrent;
/*0x218*/ uint8_t                  Unknown0x218[0x4];
/*0x21c*/ float                    Unknown0x21c;
/*0x220*/ uint8_t                  _pad_0x220[0x4];
/*0x224*/ uint32_t                 Unknown0x224;
...
/*0x249*/ bool                     bTempPet;
/*0x24a*/ uint8_t                  FishingEvent;
/*0x24b*/ bool                     bBetaBuffed;
/*0x24c*/ LaunchSpellData          CastingData;
/*0x290*/ float                    BearingToTarget;
/*0x294*/ unsigned int             LastPrimaryUseTime;
/*0x298*/ unsigned int             MasterID;
/*0x29c*/ float                    MerchantGreed;
/*0x2a0*/ int64_t                  GuildID;
/*0x2a8*/ bool                     bSummoned;
/*0x2a9*/ uint8_t                  Unknown0x2a9[0x3];
/*0x2ac*/ int                      Unknown0x2ac;
/*0x2b0*/ unsigned int             Unknown0x2b0;
/*0x2b4*/ unsigned int             LastTick;
/*0x2b8*/ int                      Anon;
/*0x2bc*/ int                      SecondaryTintIndex;
/*0x2c0*/ unsigned int             LastTrapDamageTime;
/*0x2c4*/ unsigned int             LastRefresh;
/*0x2c8*/ unsigned int             EnduranceMax;
/*0x2cc*/ unsigned int             LastSecondaryUseTime;
/*0x2d0*/ EqItemGuid               realEstateItemGuid;
/*0x2e2*/ uint8_t                  FD;
/*0x2e3*/ uint8_t                  Unknown0x2e3[0x29];
/*0x30c*/ unsigned int             LastResendAddPlayerPacket;
/*0x310*/ uint8_t                  Unknown0x310[0x30];
/*0x340*/ unsigned int             RespawnTimer;
/*0x344*/ unsigned int             Zone;
/*0x348*/ int                      FamiliarID;
/*0x34c*/ int                      Deity;
/*0x350*/ float                    FallingStartZ;
/*0x354*/ float                    CameraOffset;
/*0x358*/ unsigned int             NextSwim;
/*0x35c*/ char                     LoginRelated[0x12];
/*0x36e*/ char                     Title[0x80];
/*0x3ee*/ bool                     bStationary;
/*0x3ef*/ bool                     bShowHelm;
/*0x3f0*/ unsigned int             FishingETA;
/*0x3f4*/ unsigned int             HibernatingCount;
/*0x3f8*/ unsigned int             Unknown0x3f8;
/*0x3fc*/ bool                     LFG;
/*0x3fd*/ uint8_t                  Level;
/*0x3fe*/ uint8_t                  IntimidateCount;
/*0x3ff*/ bool                     Linkdead;
/*0x400*/ int                      PetID;
/*0x404*/ uint8_t                  _pad_0x404[0x8];
/*0x40c*/ bool                     bOfflineMode;
/*0x40d*/ uint8_t                  Unknown0x40d[0x3];
/*0x410*/ void*                    Unknown0x410[0x8];
/*0x450*/ int                      AFK;
/*0x454*/ int                      PrimaryTintIndex;
/*0x458*/ unsigned int             TimeStamp;
/*0x45c*/ unsigned int             LoginSerial;
/*0x460*/ int                      ManaCurrent;
/*0x464*/ int                      Unknown0x1e8;
/*0x468*/ unsigned int             LastMealTime;
/*0x46c*/ unsigned int             LastRangedUsedTime;
/*0x470*/ bool                     PvPFlag;
/*0x471*/ char                     Suffix[0x80];
/*0x4f1*/ bool                     Unknown0x284;
/*0x4f2*/ uint8_t                  Unknown0x230;
/*0x4f3*/ uint8_t                  Unknown0x28d;
/*0x4f4*/ int                      Unknown0x1f0;
/*0x4f8*/ CharacterZoneClient*     pCharacter;
/*0x500*/ uint32_t                 Unknown0x500;
/*0x504*/ unsigned int             SpellGemETA[15];
/*0x540*/ uint32_t                 Unknown0x540;
/*0x544*/ unsigned int             LastTimeStoodStill;
/*0x548*/ int                      Unknown0x548;
/*0x54c*/ int                      Unknown0x54c;
/*0x550*/ int                      Trader;
/*0x554*/ uint8_t                  Unknown0x554[0x4];
/*0x558*/ uint32_t                 Unknown0x558;
/*0x55c*/ uint32_t                 Unknown0x55c;
/*0x560*/ uint8_t                  Unknown0x560[0x8];
/*0x568*/ float                    RunSpeed;
/*0x56c*/ float                    AnimationSpeedRelated;
/*0x570*/ uint8_t                  Unknown0x570[0x2];
/*0x572*/ uint8_t                  Unknown0x3f0;
/*0x573*/ uint8_t                  Unknown0x249;
/*0x574*/ unsigned int             CorpseDragCount;
/*0x578*/ uint8_t                  Unknown0x578[0xc];
/*0x584*/ CPhysicsInfo             LastCollision;
/*0x5b4*/ unsigned int             Unknown0x5b4;
/*0x5b8*/ uint8_t                  Unknown0x608[0x10];
/*0x5c8*/ uint8_t                  Unknown0x630pad[0xc];
/*0x5d4*/ uint8_t                  Unknown0x2ec[0x4];
/*0x5d8*/ uint8_t                  Unknown0x620[0x8];
/*0x5e0*/ bool                     berserker;
/*0x5e1*/ uint8_t                  Original;
/*0x5e2*/ uint8_t                  AltAttack;
/*0x5e3*/ uint8_t                  FindBits;
/*0x5e4*/ uint8_t                  Light;
/*0x5e5*/ uint8_t                  Unknown0x5e5[0x2];
/*0x5e7*/ bool                     bAnimationOnPop;
/*0x5e8*/ uint8_t                  Unknown0x33a[0x6];
/*0x5ee*/ uint8_t                  CharClass;
/*0x5ef*/ uint8_t                  TitleVisible;
/*0x5f0*/ uint8_t                  Unknown0x3e2[0x6];
/*0x5f6*/ bool                     bSwitchMoved;
/*0x5f7*/ bool                     bBuffTimersOnHold;
/*0x5f8*/ int                      Unknown0x354;
/*0x5fc*/ int                      ManaMax;
/*0x600*/ int                      HideMode;
/*0x604*/ uint8_t                  Unknown0x604[0x4];
/*0x608*/ float                    MyWalkSpeed;
/*0x60c*/ uint8_t                  InPvPArea;
/*0x60d*/ uint8_t                  Unknown0x60d[0x3];
/*0x610*/ unsigned int             SpellCooldownETA;
/*0x614*/ unsigned int             Unknown0x434;
/*0x618*/ uint8_t                  Unknown0x488[0x4];
/*0x61c*/ uint8_t                  Unknown0x490[0x4];
/*0x620*/ uint8_t                  Unknown0x4a0[0x4];
/*0x624*/ int                      WarCry;
/*0x628*/ int                      IsAttacking;
/*0x62c*/ int                      NpcTintIndex;
/*0x630*/ unsigned int             Unknown0x504;
/*0x634*/ uint8_t                  Unknown0x510[0x4];
/*0x638*/ unsigned int             StunTimer;
/*0x63c*/ int                      DoSpecialMelee;
/*0x640*/ int                      Unknown0x590;
/*0x644*/ uint8_t                  Unknown0x57c[0x4];
/*0x648*/ unsigned int             Unknown0x58;
/*0x64c*/ uint8_t                  _pad_0x64c[0x10];
