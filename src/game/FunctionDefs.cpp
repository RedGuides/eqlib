...
FUNCTION_AT_ADDRESS(void, CSpellDisplayManager::ShowSpell(int SpellID, bool NewWindow, bool FullDisplay, ESpellDisplayType SpellDisplayType, int Unknown, PlayerClient* pCaster), CSpellDisplayManager__ShowSpell);
